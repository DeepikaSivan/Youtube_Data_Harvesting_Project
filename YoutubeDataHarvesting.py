...
icon = Image.open("C:\\Users\\dhamu\\Desktop\\Deepika\\Youtube logo.png")
st.set_page_config(page_title= "Youtube Data Harvesting and Warehousing | By Deepika S",
                   page_icon= icon,
                   layout= "wide",
                   initial_sidebar_state= "expanded",
                   menu_items={'About': """# This app is created by *Deepika S!*"""})


#creating option menu
with st.sidebar:
    selected = option_menu("Youtube_Data_Harvesting_Project", ["Home","Extract & Transform","View"],
                           ...
                           styles={"nav-link": {"font-size": "20px", "text-align": "centre", "margin": "0px",
                                   ...
                                   "nav-link-selected": {"background-color": "#99D2FF"}})

#Setting a connection with MongoDB Atlas and Creating a new database
client = pymongo.MongoClient("localhost:27017")
db = client.Youtube_Data

#Connecting with Postgres Database
mydb=pg.connect(host="localhost", user="postgres", password="deepika1234", database="youtube")
mycursor=mydb.cursor()

#Building connection with youtube API
api_key = "AIzaSyCxwM1AW6MvqyZv9pbx772S31Dvhrn_BLM"
...
#to get channel names from mongodb
def channel_names():
    ch_name = []
...
if selected == "Home":
    ...
    col1.markdown("## :blue[Description] : Retrieving the Youtube channels data from the Google API, storing it in a MongoDB as data lake, migrating and transforming data into a SQL database,then querying the data and displaying it in the Streamlit app.")
    col2.markdown("#   ")
    col2.markdown("#   ")
    col2.markdown("#   ")
...
#Transform tab
    ...
    if st.button("Submit"):
        try:
            ...
            st.success("Transformation to Postgres Successful !!")
        except:
